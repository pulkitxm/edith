...
| --- | --- | --- | --- |
| `id` | one of the twenty-eight ids, or a defaults key | required | The extension to turn on |
...
hint: known ids: usage, herdr, quinjet, companion, plugins, appMaintenance, homebrew, cleaner, system, keepAwake, lidAwake, systemStats, micMute, clipboard, emoji, colorPicker, keystrokeHighlight, focusDim, windowSweaters, presenter, music, downloads, notchShelf, audioMixer, calendar, database, attention, seoAudit
```
