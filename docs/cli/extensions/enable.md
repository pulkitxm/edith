...
| --- | --- | --- | --- |
| `id` | one of the nineteen ids, or a defaults key | required | The extension to turn on |
...
hint: known ids: attention, usage, herdr, quinjet, system, machines, companion, systemStats, micMute, lidAwake, music, calendar, notchShelf, clipboard, focusDim, presenter, emoji, colorPicker, captureTools
```
