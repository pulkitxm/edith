...
| Notch Shelf | decodable shelf index plus macOS 14.4 or later for application audio | parked item count and missing backing files; Audio Mixer is omitted on unsupported systems | `ed shelf ls --json`; `ed permissions settings applicationAudio` |
