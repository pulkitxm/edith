...
Diagnoses setup and runtime problems for one extension or all twenty-nine.
...
All twenty-nine extensions have an explicit live adapter. A missing adapter is
