...
Diagnoses setup and runtime problems for one extension or all registered extensions.
...
All registered extensions have an explicit live adapter. A missing adapter is
