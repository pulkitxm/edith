...
Diagnoses setup and runtime problems for one extension or all twenty-eight.
...
All twenty-eight extensions have an explicit live adapter. A missing adapter is
