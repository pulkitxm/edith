...
| --- | --- | --- | --- |
| `--group` | one of `appearance`, `panel`, `usage`, `limits`, `menubar`, `alerts`, `budget`, `dashboard`, `machines`, `companion`, `finder`, `system`, `cleaner`, `music`, `calendar`, `clipboard`, `scratchpad`, `notch`, `focusdim`, `presenter`, `colorpicker`, `micmute`, `backup`, `permissions`, `terminal` | none | Only settings in this group |
