...
| `camera` | Privacy & Security > Camera | The Virtual Camera feed and preview, and the Notch Shelf camera preview | required by `virtualCamera`, optional for `notchShelf` |
