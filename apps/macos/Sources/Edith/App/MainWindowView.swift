...
enum SettingsDestination: String, CaseIterable, Identifiable {
    case usage, music, calendar, system, standup, general, permissions, backup
    var id: String { rawValue }
    ...
    var icon: String {
        ...
        case .standup: return "person.crop.circle.badge.clock"
    ...
    static let modules: [SettingsDestination] = [.usage, .music, .calendar, .system, .standup]
