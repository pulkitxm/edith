...
- **System tools** - independent Keep Awake toggle, a native System Monitor for CPU, memory, GPU, network, disk, battery and power, sustained pressure alerts, and a keyboard-cleaning lock that auto-restores after 60s.
