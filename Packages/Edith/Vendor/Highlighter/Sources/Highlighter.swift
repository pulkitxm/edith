...
open class Highlighter {
    ...
    public init?() {
        ...
        // Bundle.module, whose accessor calls fatalError instead of returning
        // nil and never looks in an .app's Contents/Resources.
        guard let bundle = BundledResources.bundle(named: "Edith_Highlighter")
