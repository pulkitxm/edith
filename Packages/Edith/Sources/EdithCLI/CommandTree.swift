            ...
            CommandNode(
                ...
                children: [
                    ...
                    CommandNode(
                        ...
                        options: common),
                    CommandNode(
                        "record", "Record and edit an area, window, or display.",
                        children: [
                            CommandNode("area", "Select and record an area.", options: common),
                            CommandNode("window", "Choose and record a window.", options: common),
