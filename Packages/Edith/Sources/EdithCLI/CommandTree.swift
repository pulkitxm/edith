...
public enum CommandTree {
    ...
    static let specs: [String: Spec] = [
        "ed network": Spec(options: ["--json", "--target", "--dns", "--http", "--https", "--service", "--exclude", "--public-ip", "--timeout", "--retries", "--count", "--save-baseline", "--no-history"]),
        "ed network baseline": Spec(options: ["--json"]),
        "ed network diagnose": Spec(options: ["--json", "--target", "--dns", "--http", "--https", "--service", "--exclude", "--public-ip", "--timeout", "--retries", "--count", "--save-baseline", "--no-history"]),
