...
public enum CommandTree {
    ...
    static let specs: [String: Spec] = [
        ...
        "ed window workspace": Spec(options: ["--json"]),
        ...
        "ed window workspace duplicate": Spec(options: ["--json"]),
        "ed window workspace delete": Spec(options: ["--json"]),
        "ed window workspace export": Spec(options: ["--json"]),
        "ed window workspace import": Spec(options: ["--json"]),
        "ed window workspace history": Spec(options: ["--json"]),
        ...
        "ed agent run": Spec(options: common),
        "ed agent cancel": Spec(options: common),
        "ed agent tasks ls": Spec(options: common),
        "ed agent tasks inspect": Spec(options: common),
        "ed agent tasks cancel": Spec(options: common),
        "ed agent tasks exec": Spec(options: ["--json", "--detach", "--timeout"]),
