...
public enum CommandTree {
    ...
    static let specs: [String: Spec] = [
        ...
        "ed automations enable": Spec(options: common, arguments: [.free]),
        "ed automations disable": Spec(options: common, arguments: [.free]),
        "ed automations history": Spec(options: ["--json", "--help", "--limit"]),
        "ed automations export": Spec(options: common, arguments: [.localPath]),
        "ed automations import": Spec(
