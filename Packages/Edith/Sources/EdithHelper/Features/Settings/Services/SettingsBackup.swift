...
final class SettingsBackup {
    ...
    nonisolated static let backedKeys = [
        ...
        AppStorageKeys.Tabs.musicEnabled, AppStorageKeys.Tabs.mediaToolkitEnabled,
        AppStorageKeys.MediaToolkit.imageFormat, AppStorageKeys.MediaToolkit.imageMaxDimension,
        AppStorageKeys.MediaToolkit.imageQuality, AppStorageKeys.MediaToolkit.videoKeepAudio,
        AppStorageKeys.MediaToolkit.videoTargetMegabytes, "usageMachines",
