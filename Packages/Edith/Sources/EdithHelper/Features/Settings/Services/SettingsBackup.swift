...
final class SettingsBackup {
    ...
    nonisolated static let backedKeys = [
        ...
        "micHotKeyCode", "micHotKeyMods", "micHotKeyLabel",
        "pushToTalkEnabled", "pushToTalkHotKeyCode", "pushToTalkHotKeyMods",
        "pushToTalkHotKeyLabel", "cleanerSelectionOverrides",
        ...
        "pasteQueueEnabled", "pasteQueueHotKeyCode", "pasteQueueHotKeyMods",
        "pasteQueueHotKeyLabel", "hyperKeyEnabled",
        "scratchpadEnabled", "scratchpadHotKeyCode", "scratchpadHotKeyMods",
        "scratchpadHotKeyLabel",
