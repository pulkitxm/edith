...
final class SettingsBackup {
    ...
    nonisolated static let backedKeys = [
        ...
        AppStorageKeys.FinderTools.enabled, AppStorageKeys.FinderTools.cutPaste,
        AppStorageKeys.FinderTools.rename, AppStorageKeys.FinderTools.pasteImages,
        ...
        AppStorageKeys.MenuBar.statsColorHex, AppStorageKeys.MenuBar.statsAlerts,
        AppStorageKeys.MenuBar.statsCPUThreshold, AppStorageKeys.MenuBar.statsMemoryThreshold,
        AppStorageKeys.MenuBar.statsDiskThreshold, AppStorageKeys.MenuBar.statsBatteryThreshold,
        ...
        AppStorageKeys.WindowSwitcher.enabled, AppStorageKeys.WindowSwitcher.grouped,
        AppStorageKeys.WindowSwitcher.includedApps, AppStorageKeys.WindowSwitcher.hiddenApps,
        AppStorageKeys.WindowSwitcher.showHotKeyCode,
        AppStorageKeys.WindowSwitcher.showHotKeyMods,
        AppStorageKeys.WindowSwitcher.showHotKeyLabel,
        AppStorageKeys.WindowSwitcher.cycleHotKeyCode,
        AppStorageKeys.WindowSwitcher.cycleHotKeyMods,
        AppStorageKeys.WindowSwitcher.cycleHotKeyLabel,
