...
public enum ClipboardPayloadExtractor {
    ...
    private static func fileListPreview(_ urls: [URL]) -> String {
        ...
        let suffix = urls.count > names.count ? ", +\(urls.count - names.count) more" : ""
    ...
    private static func richTextPayload(from pasteboard: NSPasteboard) -> ClipboardPayload? {
        ...
        for format in richTextFormats {
            ...
            return ClipboardPayload(
                data: data, types: [format.type.rawValue], ext: format.ext,
                preview: preview(for: directText, fallback: format.preview))
        }
        return nil
    }
    ...
    public static func preview(for text: String?, fallback: String) -> String {
    ...
    public static func hasRenderableText(_ text: String?) -> Bool {
    ...
    public static func decodeText(_ data: Data, permissive: Bool) -> String? {
