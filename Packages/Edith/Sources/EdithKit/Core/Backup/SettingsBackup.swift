...
final class SettingsBackup {
    ...
    private nonisolated static let baseBackedKeys = [
        ...
        AppStorageKeys.TextUtilities.enabled, AppStorageKeys.TextUtilities.snippetsEnabled,
        AppStorageKeys.TextUtilities.snippets, AppStorageKeys.TextUtilities.cleanCopiedURLs,
        AppStorageKeys.TextUtilities.customTrackingParameters,
        AppStorageKeys.TextUtilities.autoClearEnabled,
        AppStorageKeys.TextUtilities.autoClearDelay, AppStorageKeys.TextUtilities.clearOnLock,
        AppStorageKeys.TextUtilities.clearOnSleep, AppStorageKeys.TextUtilities.hotKeyCode,
        AppStorageKeys.TextUtilities.hotKeyMods, AppStorageKeys.TextUtilities.hotKeyLabel,
