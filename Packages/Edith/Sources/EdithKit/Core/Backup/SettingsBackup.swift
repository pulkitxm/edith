...
final class SettingsBackup {
    ...
    private nonisolated static let baseBackedKeys = [
        ...
        AppStorageKeys.Audio.enabled, AppStorageKeys.Audio.preferredInputUID,
        AppStorageKeys.Audio.lowerOnHeadphoneDisconnect,
        AppStorageKeys.Audio.safeOutputPercent, AppStorageKeys.Audio.appOutputRoutes,
        AppStorageKeys.Audio.blockMusicLaunch,
