...
final class SettingsBackup {
    ...
    private nonisolated static let baseBackedKeys = [
        ...
        AppStorageKeys.KeyboardTools.enabled, AppStorageKeys.KeyboardTools.debounceEnabled,
        AppStorageKeys.KeyboardTools.debounceWindow, AppStorageKeys.KeyboardTools.superEnabled,
        AppStorageKeys.KeyboardTools.superTapAction, AppStorageKeys.KeyboardTools.superHoldAction,
