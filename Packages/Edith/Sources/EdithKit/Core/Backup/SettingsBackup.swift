...
final class SettingsBackup {
    ...
    private nonisolated static let baseBackedKeys = [
        ...
        AppStorageKeys.CommandBar.fileScopes, AppStorageKeys.CommandBar.pinnedResults,
        AppStorageKeys.CommandBar.hiddenResults, AppStorageKeys.CommandBar.resultShortcuts,
