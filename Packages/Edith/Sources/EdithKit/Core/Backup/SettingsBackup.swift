...
final class SettingsBackup {
    ...
    private nonisolated static let baseBackedKeys = [
        ...
        AppStorageKeys.Tabs.musicEnabled, AppStorageKeys.Tabs.videoEditorEnabled, "usageMachines",
        ...
        AppStorageKeys.Herdr.ghosttyTerminal, AppStorageKeys.Herdr.launchDefaults,
        ...
        AppStorageKeys.Tabs.systemEnabled,
        AppStorageKeys.General.keepAwakeEnabled, AppStorageKeys.General.preventSleep,
        ...
        AppStorageKeys.Tabs.pluginsEnabled, AppStorageKeys.Skills.agentSelections,
        ...
        AppStorageKeys.Notify.trackWeekly, AppStorageKeys.Notify.onPace,
        AppStorageKeys.Notify.almostCapped, AppStorageKeys.Notify.almostCappedPercent,
        AppStorageKeys.Notify.capped, AppStorageKeys.Notify.back,
        AppStorageKeys.Notify.outlook, AppStorageKeys.Notify.headroom,
        ...
        AppStorageKeys.VirtualCamera.enabled, AppStorageKeys.VirtualCamera.state,
        AppStorageKeys.VirtualCamera.hotKeyCode, AppStorageKeys.VirtualCamera.hotKeyMods,
        AppStorageKeys.VirtualCamera.hotKeyLabel,
        ...
        AppStorageKeys.Notch.browserEnabled, AppStorageKeys.Notch.browserSearchEngine,
        ...
        AppStorageKeys.KeystrokeHighlight.enabled, AppStorageKeys.KeystrokeHighlight.active,
        AppStorageKeys.KeystrokeHighlight.duration, AppStorageKeys.KeystrokeHighlight.position,
        AppStorageKeys.KeystrokeHighlight.hotKeyCode,
        AppStorageKeys.KeystrokeHighlight.hotKeyMods,
        AppStorageKeys.KeystrokeHighlight.hotKeyLabel,
        ...
        SweaterState.enabledKey, AppStorageKeys.WindowSweaters.pattern,
        AppStorageKeys.WindowSweaters.stitch, AppStorageKeys.WindowSweaters.basket,
        AppStorageKeys.WindowSweaters.borderWidth, AppStorageKeys.WindowSweaters.gauge,
        AppStorageKeys.WindowSweaters.anchor, AppStorageKeys.WindowSweaters.order,
        AppStorageKeys.WindowSweaters.unfocusedDim,
        AppStorageKeys.WindowSweaters.accessibilityFocus,
        AppStorageKeys.WindowSweaters.excludedApps,
        ...
        AppStorageKeys.Bifrost.enabled, AppStorageKeys.Bifrost.popupAt,
        AppStorageKeys.Bifrost.resultLimit, AppStorageKeys.Bifrost.usage,
        AppStorageKeys.Bifrost.hotKeyCode, AppStorageKeys.Bifrost.hotKeyMods,
        AppStorageKeys.Bifrost.hotKeyLabel,
        AppStorageKeys.Bifrost.quicklinks, AppStorageKeys.Bifrost.snippets,
        AppStorageKeys.Bifrost.shellCommands, AppStorageKeys.Bifrost.pasteSnippets,
        AppStorageKeys.Bifrost.sourceQuicklinks, AppStorageKeys.Bifrost.sourceSnippets,
        AppStorageKeys.Bifrost.sourceShellCommands,
        AppStorageKeys.Bifrost.sourceAppleShortcuts,
        AppStorageKeys.Bifrost.sourceWindowActions,
        AppStorageKeys.Bifrost.sourceSystemActions,
        AppStorageKeys.Bifrost.sourceRunningApplications,
        AppStorageKeys.Bifrost.sourceOpenWindows,
    ...
    private nonisolated static let baseSharedKeys: Set<String> = [
        ...
        "presenterHotKeyCode", "presenterHotKeyMods", "presenterHotKeyLabel",
        AppStorageKeys.Tabs.attentionEnabled, AppStorageKeys.Tabs.usageEnabled,
        AppStorageKeys.Tabs.musicEnabled, AppStorageKeys.Tabs.videoEditorEnabled,
        AppStorageKeys.Tabs.herdrEnabled, AppStorageKeys.Tabs.quinjetEnabled,
        AppStorageKeys.Tabs.seoAuditEnabled,
        AppStorageKeys.Homebrew.defaultKind,
        AppStorageKeys.Herdr.ghosttyTerminal, AppStorageKeys.Herdr.launchDefaults,
        ...
        AppStorageKeys.Notify.capped, AppStorageKeys.Notify.back,
        AppStorageKeys.Notify.outlook, AppStorageKeys.Notify.headroom,
        AppStorageKeys.Notify.loginProblems, AppStorageKeys.General.hotKeyCode,
    ...
    nonisolated static let deviceLocalKeys: Set<String> = [
        ...
        AppStorageKeys.Clipboard.lastBackupAt, AppStorageKeys.Clipboard.capturePaused,
        "micMuted", "migratedFromControlCenter",
        AppStorageKeys.Permissions.filter, "permissionPromptCount",
        "permissionHintShown",
        "focusDimActive", SweaterState.activeKey,
        AppStorageKeys.KeystrokeHighlight.runtimeActive,
        AppStorageKeys.KeystrokeHighlight.runtimeError,
        ...
        AppStorageKeys.Presenter.autoReason, AppStorageKeys.General.settingsSection,
