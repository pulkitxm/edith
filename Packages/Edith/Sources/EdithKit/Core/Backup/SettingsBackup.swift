...
final class SettingsBackup {
    ...
    private nonisolated static let baseBackedKeys = [
        ...
        AppStorageKeys.Tabs.quickActionsEnabled,
        AppStorageKeys.QuickActions.appearance, AppStorageKeys.QuickActions.keyboardLight,
        AppStorageKeys.QuickActions.emptyTrash, AppStorageKeys.QuickActions.ejectDisks,
        AppStorageKeys.QuickActions.hiddenFiles, AppStorageKeys.QuickActions.desktopIcons,
        AppStorageKeys.QuickActions.lockScreen,
    ...
    private nonisolated static let baseSharedKeys: Set<String> = [
        ...
        AppStorageKeys.Herdr.ghosttyTerminal,
        AppStorageKeys.Quinjet.terminal, AppStorageKeys.Quinjet.theme,
        AppStorageKeys.Tabs.systemEnabled, AppStorageKeys.Tabs.quickActionsEnabled,
        AppStorageKeys.QuickActions.appearance, AppStorageKeys.QuickActions.keyboardLight,
        AppStorageKeys.QuickActions.emptyTrash, AppStorageKeys.QuickActions.ejectDisks,
        AppStorageKeys.QuickActions.hiddenFiles, AppStorageKeys.QuickActions.desktopIcons,
        AppStorageKeys.QuickActions.lockScreen, AppStorageKeys.Tabs.calendarEnabled,
        AppStorageKeys.Tabs.order,
        "usageMachines",
        AppStorageKeys.Machines.notifyDown,
        AppStorageKeys.Machines.notifyDiskFull,
