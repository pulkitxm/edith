...
final class SettingsBackup {
    ...
    private nonisolated static let baseBackedKeys = [
        ...
        AppStorageKeys.Capture.enabled, AppStorageKeys.Capture.copyMode,
        AppStorageKeys.Capture.copyAfterCapture, AppStorageKeys.Capture.saveFolder,
        AppStorageKeys.Capture.filenameTemplate,
        AppStorageKeys.Capture.detectCodes, AppStorageKeys.Capture.history,
        AppStorageKeys.Capture.historySize, AppStorageKeys.Capture.saveScreenshots,
        AppStorageKeys.Capture.readHotKeyCode, AppStorageKeys.Capture.readHotKeyMods,
        AppStorageKeys.Capture.readHotKeyLabel, AppStorageKeys.Capture.screenshotHotKeyCode,
        AppStorageKeys.Capture.screenshotHotKeyMods, AppStorageKeys.Capture.screenshotHotKeyLabel,
        AppStorageKeys.Capture.recordingSystemAudio,
        AppStorageKeys.Capture.recordingMicrophone, AppStorageKeys.Capture.recordingFrameRate,
        AppStorageKeys.Capture.recordingPresets, AppStorageKeys.Capture.recordingHotKeyCode,
        AppStorageKeys.Capture.recordingHotKeyMods, AppStorageKeys.Capture.recordingHotKeyLabel,
