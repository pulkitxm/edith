...
final class SettingsBackup {
    ...
    private nonisolated static let baseBackedKeys = [
        ...
        AppStorageKeys.Scratchpad.enabled, AppStorageKeys.Scratchpad.alwaysOnTop,
        AppStorageKeys.Scratchpad.dismissOnDeactivate, AppStorageKeys.Scratchpad.retention,
        AppStorageKeys.Scratchpad.hotKeyCode, AppStorageKeys.Scratchpad.hotKeyMods,
        AppStorageKeys.Scratchpad.hotKeyLabel,
