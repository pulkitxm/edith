...
final class SettingsBackup {
    ...
    private nonisolated static let baseBackedKeys = [
        ...
        AppStorageKeys.DockTools.enabled, AppStorageKeys.DockTools.previewMode,
        AppStorageKeys.DockTools.hoverDelay, AppStorageKeys.DockTools.clickAction,
        AppStorageKeys.DockTools.greenButtonMaximizes,
        AppStorageKeys.DockTools.quitOnLastWindow, AppStorageKeys.DockTools.excludedApps,
