...
final class SettingsBackup {
    ...
    private nonisolated static let baseBackedKeys = [
        ...
        AppStorageKeys.WindowTools.enabled, AppStorageKeys.WindowTools.greenButtonMaximizes,
        AppStorageKeys.WindowTools.leftHotKeyCode, AppStorageKeys.WindowTools.leftHotKeyMods,
        AppStorageKeys.WindowTools.leftHotKeyLabel,
        AppStorageKeys.WindowTools.rightHotKeyCode, AppStorageKeys.WindowTools.rightHotKeyMods,
        ...
        AppStorageKeys.WorkspaceRestorer.enabled, AppStorageKeys.WorkspaceRestorer.library,
        AppStorageKeys.WorkspaceRestorer.excludedApps,
        AppStorageKeys.WorkspaceRestorer.launchPolicy, AppStorageKeys.WorkspaceRestorer.timeout,
        AppStorageKeys.WorkspaceRestorer.concurrency,
        AppStorageKeys.WorkspaceRestorer.captureHotKeyCode,
        AppStorageKeys.WorkspaceRestorer.captureHotKeyMods,
        AppStorageKeys.WorkspaceRestorer.captureHotKeyLabel,
        AppStorageKeys.WorkspaceRestorer.restoreHotKeyCode,
        AppStorageKeys.WorkspaceRestorer.restoreHotKeyMods,
        AppStorageKeys.WorkspaceRestorer.restoreHotKeyLabel,
