...
public enum IPC {
    public enum Name {
        ...
        public static let requestPasteQueue = Notification.Name(
            "com.pulkit.edith.requestPasteQueue")
        public static let pasteQueueResult = Notification.Name("com.pulkit.edith.pasteQueueResult")
