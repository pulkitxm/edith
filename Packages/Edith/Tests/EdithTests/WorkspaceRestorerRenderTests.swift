...
@Suite @MainActor struct WorkspaceRestorerRenderTests {
    @Test func settingsRenderWithWorkspaceActions() throws {
        let defaults = SharedDefaults.store
        let key = AppStorageKeys.WorkspaceRestorer.enabled
