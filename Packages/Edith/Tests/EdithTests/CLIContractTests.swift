...
enum JSONContract {
    static let cases: [JSONCase] = [
        ...
        JSONCase("ed app relaunch", ["app", "relaunch", "--json"]),
        JSONCase(
            "ed app clear-updates", ["app", "clear-updates", "--json"]),
        ...
        JSONCase("ed extensions status", ["extensions", "status", "--json"]),
        JSONCase(
            "ed extensions setup",
            ["extensions", "setup", "clipboard", "--dry-run", "--json"]),
        ...
        JSONCase("ed camera pause", ["camera", "pause", "--json"]),
        JSONCase("ed camera resume", ["camera", "resume", "--json"]),
        JSONCase("ed camera scene list", ["camera", "scene", "list", "--json"]),
        JSONCase("ed camera scene apply", ["camera", "scene", "apply", "Close-up", "--json"]),
