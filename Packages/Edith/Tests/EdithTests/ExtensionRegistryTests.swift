    ...
    @Test func registryMatchesCurrentBaseline() {
        #expect(
            ExtensionRegistry.entries.map(\.id) == [
                ...
                "scratchpad", "emoji", "colorPicker", "keystrokeHighlight", "focusDim", "presenter",
                "music", "downloads", "notchShelf", "audioMixer", "calendar", "database",
                "attention", "seoAudit",
            ])
    }
    ...
    @Test func featuredEntriesArePresent() {
        ...
        #expect(
            featuredIdentifiers == [
                ...
                "keystrokeHighlight", "notchShelf", "database", "attention", "scratchpad",
            ])
    }
